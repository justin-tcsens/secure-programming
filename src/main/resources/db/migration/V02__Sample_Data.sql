insert into vehicle (carplate_num,make,model,chassis_num,axles_num,tyre_num,roadtax_expiry,manufacture_year,image_name) values 
('JPM1575','NISSAN','ALMERA','A893837100AA0101709',2,4,'2023-06-25','2017','JPM1575.jpg'),
('WSC9542','PROTON','X50','B29701091UD10978201',2,4,'2023-08-01','2020','WSC9542.jpg'),
('VAA426','PROTON','X70','T66545613116544A122',2,4,'2023-11-25','2021','VAA426.jpg'),
('MXA5587','HYUNDAI','KONA','F843864A348Y8546547',2,4,'2023-12-05','2022','MXA5587.jpg'),
('NAN5022','TOYOTA','CAMRY','J6546E4664Q67411687',2,4,'2023-07-04','2019','NAN5022.jpg'),
('DAC2275','HONDA','ACCORD','H5668I86468434824Q7',2,4,'2023-08-08','2020','DAC2275.jpg');
...
((select id from vehicle where carplate_num = 'JPM1575'),'K000008818',250,'BATU CAVES, SELANGOR.','TN. SHAMIR');
